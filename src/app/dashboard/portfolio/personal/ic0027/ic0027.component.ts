import { Component, Renderer, OnInit, Input, OnDestroy, OnChanges, EventEmitter, Output, AfterViewInit, ViewChild, ElementRef } from '@angular/core';
import { FormGroup, FormBuilder, FormControl } from '@angular/forms';
import { IC0027, HobbiesInterestsEntity } from 'core/interfaces/Portfolio/Personal/IC0027';
...
@Component({
  selector: 'app-ic0027',
  templateUrl: './ic0027.component.html',
  styleUrls: ['./ic0027.component.css']
})
export class IC0027Component implements OnInit, OnChanges, OnDestroy, AfterViewInit {
  title_modal:string;
  index:number;
  closeResult: string;
  show_alert= false;
  public value = false;
  completed: boolean;
    newItem: HobbiesInterestsEntity;
    errorMessage: string;
    container_name= "Hobbies & Interests";
    container_id = 'a45130da-731e-4e1c-8cdd-3409e59a39c1';
    errorGet = 'Cannot Get ' + this.container_name;
    errorUpdate = 'Cannot Update' + this.container_name;
    container_tooltip = "Tell us about your hobbies and interests. They may tell college admissions officers something intriguing about you and will help you stand out in the crowd of applicants.";
    @Input() container: IC0027;
    @Output() EventOutput: EventEmitter<IC0027> = new EventEmitter<IC0027>();
    private apiResponse: IUserPortfolioContainerResponse;
    private standardResponse: IStandardResponse;
    valuetest: number;
    header: any;
    private uploadUrl;
    hobbies_image_default: string;
    ...
    ngOnInit() {
      ...
      this.getContainer();
      this.hobbies_image_default = "assets/images/home/icons8c.png";
    ...
    updateContainer() {
      ...
      putRequest.container_code = 'IC0027';
    ...
    removeItem(index: number) {
      ...
      setTimeout(() => {
        this.container.hobbies_interests.splice( index, 1);
        this.updateContainer();
      }, 600);
    }
    addItem(): boolean{
  ...
  const CONTAINER: IC0027 = {
    completed: true,
    hobbies_interests: [
      { url_image: "assets/images/home/icons8c.png", award: "First Place",name: 'Cooking', description: "It was a hard competition!"}//,
