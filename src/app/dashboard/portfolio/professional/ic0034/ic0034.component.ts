import { Component, OnInit, OnChanges, OnDestroy, Input, EventEmitter, Output, ViewChild, AfterViewInit, ElementRef } from '@angular/core';
import { IC0034 } from 'core/interfaces/Portfolio/Professional/IC0034';
...
@Component({
  selector: 'app-ic0034',
  templateUrl: './ic0034.component.html',
  styleUrls: ['./ic0034.component.css']
})
export class IC0034Component implements OnInit, OnChanges, OnDestroy, AfterViewInit {
  public value = false;
  container_tooltip = "Honors given in recognition of outstanding achievement in the workplace or in practical areas outside of school.";
  container_name= "Achievements & Awards";

  errorMessage: string;
  container_id = '07655301-60ef-4d27-bd07-d70a89c84363';
  @Input() container: IC0034;
  @Output() EventOutput: EventEmitter<IC0034> = new EventEmitter<IC0034>();
      ...
      .subscribe(response => {
        ...
        if (this.apiResponse.response.code === 'AM0000') {
          if (this.apiResponse.container) {
            try {
              this.container = <IC0034>JSON.parse(this.apiResponse.container.json);
